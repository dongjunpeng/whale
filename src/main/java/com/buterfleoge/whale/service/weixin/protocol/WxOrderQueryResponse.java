...
public class WxOrderQueryResponse extends BaseObject {

    public interface TradeStatusContants {
        String TRADE_STATUS_SUCCESS = "SUCCESS"; // 支付成功
        String TRADE_STATUS_REFUND = "REFUND"; // 转入退款
        String TRADE_STATUS_NOTPAY = "NOTPAY"; // 未支付
        String TRADE_STATUS_CLOSED = "CLOSED"; // 已关闭
        String TRADE_STATUS_REVOKED = "REVOKED"; // 已撤销
        String TRADE_STATUS_USERPAYING = "USERPAYING"; // 用户支付中
        String TRADE_STATUS_PAYERROR = "PAYERROR"; // 支付失败
    }
    ...
    /**
     * @param trade_state_des
     *            the trade_state_des to set
     */
