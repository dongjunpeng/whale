...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='出行人信息';
...
CREATE TABLE `account_info` (
  ...
  `type` smallint(4) NOT NULL DEFAULT '0' COMMENT '账户类型',
  `status` smallint(4) NOT NULL DEFAULT '0' COMMENT '账户状态',
  `id` varchar(255) NOT NULL DEFAULT '' COMMENT '证件号码',
  `id_type` smallint(4) NOT NULL DEFAULT '0' COMMENT '证件类型',
...
) ENGINE=InnoDB AUTO_INCREMENT=10003 DEFAULT CHARSET=utf8 COMMENT='账户信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `discount` VALUES (1,1,1,20,'单人优惠',0,1467216000000,0),(2,2,1,200,'两人同行优惠',0,1467216000000,0),(3,6,1,50,'订单时间相关优惠',0,1467216000000,0),(4,7,1,150,'出行时间相关优惠',0,1467216000000,0),(5,8,1,88,'路线相关优惠',0,1467216000000,0),(6,3,1,400,'三人同行减400',0,1467216000000,0),(7,9,1,400,'学生证优惠',0,1467216000000,0);
...
CREATE TABLE `order_discount` (
  ...
  `discount_code` varchar(255) DEFAULT NULL COMMENT '优惠码',
  `type` smallint(4) NOT NULL DEFAULT '0' COMMENT '折扣类型',
  `routeid` bigint(20) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=97 DEFAULT CHARSET=utf8 COMMENT='订单优惠';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `order_info` (
  ...
  `count` smallint(4) DEFAULT NULL COMMENT '订单人数',
  `student_count` smallint(4) DEFAULT NULL,
  `price` bigint(20) DEFAULT NULL COMMENT '订单总价',
  `actual_price` bigint(20) DEFAULT NULL COMMENT '实际付款',
  `is_agreed` tinyint(1) DEFAULT NULL COMMENT '是否同意条款',
...
) ENGINE=InnoDB AUTO_INCREMENT=76 DEFAULT CHARSET=utf8 COMMENT='订单信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `order_refound` (
  ...
  `type` smallint(4) NOT NULL COMMENT '退款方式',
  `refound` bigint(20) NOT NULL COMMENT '实际退款金额',
  `description` varchar(255) DEFAULT NULL COMMENT '退款描述',
  `add_time` bigint(20) NOT NULL DEFAULT '0' COMMENT '创建时间',
  `finish_time` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`refoundid`) COMMENT '主键',
  UNIQUE KEY `refoundid_UNIQUE` (`refoundid`) COMMENT '主键',
  KEY `orderid_INDEX` (`orderid`) COMMENT 'orderid索引'
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='订单优惠';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `order_travellers` (
  ...
  KEY `accountid_INDEX` (`accountid`) COMMENT 'accountid索引',
  KEY `orderid_INDEX` (`orderid`) COMMENT 'orderid索引'
) ENGINE=InnoDB AUTO_INCREMENT=101 DEFAULT CHARSET=utf8 COMMENT='出行人信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `travel_group` (
  ...
  `status` smallint(4) NOT NULL DEFAULT '0' COMMENT '发团状态',
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='发团信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `travel_group` VALUES (1,1,1438876800000,1439481600000,'',3800000,5,39,10,20,'',1465793846776,1465793846776),(2,1,1443628800000,1444147200000,'',3900000,5,39,10,20,'',1465793846776,1465793846776),(3,1,1464364800000,1464883200000,'',4400000,4,39,10,0,'',1465793846776,1465793846776),(4,1,1464969600000,1465488000000,'一队',4600000,3,40,10,6,'',1465793846776,1465793846776),(5,1,1464969600000,1465488000000,'二队',4600000,1,20,10,10,'',1465793846776,1465793846776),(6,1,1466179200000,1466697600000,'',4400000,1,20,10,8,'',1465793846776,1465793846776),(7,2,1466179200000,1466697600000,'一队',4400000,1,20,0,1,'',1465793846776,1465793846776),(8,2,1466179200000,1466697600000,'二队',4400000,1,20,0,0,'',1465793846776,1465793846776);
...
CREATE TABLE `travel_route` (
  ...
  `cover` varchar(2000) NOT NULL DEFAULT '' COMMENT '封面文字',
...
-- Dump completed on 2016-06-13 13:09:03
